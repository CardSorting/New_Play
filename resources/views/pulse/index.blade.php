            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900" 
                    x-data="{ 
                        ...
                        async claimPulse() {
                            ...
                            console.log('Attempting to claim pulse');
                            const csrf = document.querySelector('meta[name=csrf-token]');
                            console.log('CSRF token present:', csrf !== null);
                ...
                >
                    <div class="text-center mb-8">
                        ...
                        <div class="mb-6">
                            <p class="text-lg font-medium">Current Balance: <span x-text="creditBalance.toLocaleString()"></span> Pulse</p>
                        </div>
